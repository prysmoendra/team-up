        ...
        if (true) {
            ...
            if (password_verify($password, $pass_result['password'])) {
                ...
                if (true) {
                    ...
                    echo "<script type='text/javascript'>alert('Welcome to TeamUp $row[name]!');document.location='../layout/page_dashboard.php';</script>";
                } 
            } else {
                echo "<script type='text/javascript'>alert('Your Username or Password INCORECT! Please check again!');document.location='../layout/page_signin.php';</script>";
            }
        }
    }
?>