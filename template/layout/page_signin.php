...
<?php
    require_once("../module/auth-signin.php");
    ...
    <section class="main-content max-h-screen">
        ...
        <div class="navbar flex justify-between items-center p-4 mx-10">
            ...
            <div class="logo md:order-1 text-center flex">
                <div class="p-1 w-48">
                    <img class="h-10 w-26 md:h-12 md:w-28" src="../../public/images/logo-teamUp.png" alt="TeamUp">
                </div>
            </div>
        ...
        <div class="flex justify-center items-center h-full flex-col pt-8">
            <form method="POST" action="" class="bg-white p-5 rounded w-full md:w-1/3">

                <h1 class="text-4xl font-semibold mb-2 text-center">Sign in to your account</h1>
                <h4 class="text-2xl font-normal mb-6 text-center text-gray-500">To get started, please sign in</h4>
                ...
                <div class="flex justify-between">
                    <div class="flex items-center mb-4">
                        <input type="checkbox" id="remember" name="remember" class="w-4 h-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500 focus:ring-w-2">
                        <label for="remember" class="ml-2 text-base text-gray-800">Remember me</label>
                    </div>
                    <div class="flex items-start mb-4 p-2">
                        <label title="Resetting Password" class="ml-2 text-base text-gray-800">Forgot password?</label>
                        <!-- <a href="#" class="text-sm text-gray-600 hover:text-gray-700 block mt-4 text-center">Forgot password?</a> -->
                    </div>
                </div>

                <button type="submit" class="w-full px-4 py-3.5 rounded-xl bg-[#007ABF] text-white text-xl font-normal tracking-wider shadow-sm hover:bg-[#1E98F0]">Sign in</button>
            </form>
            ...
            <div class="flex flex-row space-x-6 items-center p-0">
                <!-- google button -->
                <div title="Continue with Google" class="w-[52px] y-[50px] border-2 border-gray-300 rounded-full my-4 hover:bg-gray-200 hover:drop-shadow-md">
                    <img class="p-2 md:h-12 md:w-28" src="../../public/images/google-icon.png" alt="google-icon-logo">
                </div>
                <!-- facebook button -->
                <div title="Continue with Facebook" class="w-[52px] y-[50px] border-2 border-gray-300 rounded-full my-4 hover:bg-gray-200 hover:drop-shadow-md">
                    <img class="p-3 md:h-12 md:w-28" src="../../public/images/fb-icon.png" alt="facebook-icon-logo">
                </div>
            </div>

            <div class="flex flex-row p-4 pb-[168px]">
                <div class=""><p class="pr-1 tracking-wide text-gray-600 font-light">Don't have an account?</p></div>
                <div class="">
                    <a href="./page_signup.php" class="tracking-wide font-medium text-gray-600 hover:text-blue-500">Create an account</a>
                </div>
            </div>
        </div>
